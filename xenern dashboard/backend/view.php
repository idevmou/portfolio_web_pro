...
//     mysqli_query($conn,"UPDATE `add_user` SET    `amount`='$amount',`status`= '$status' WHERE `pt_no`='$key'");
...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Xenern View Candidate </title>
                              ...
                              <form action="#" method="post">
                                 ...
                                 <select class="custom-select" id="inputGroupSelect01" name="status" aria-required="true">
                                    ...
                                    <!-- <div class="col align-items-center">
                                        <a class="col-sm-12 btn btn-success" href="tel:<?php echo $row['phone_number']?>"><?php echo "Call : ".$row['phone_number']?></a><br><br><br> -->
                                        <!-- <p>Customer Id</p> -->
                                    ...
                                    <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['screenshot'])?>". alt="..." class="img-thumbnail">
                                    </div>
